export const DEFAULT_LANGUAGE_MODEL: LanguageModel = 'GERMAN'
...
export const possibleModelsDefault: Partial<LanguageModel>[] = ['GERMAN']
export const possibleModelsExperimental: LanguageModel[] = ['FB']
