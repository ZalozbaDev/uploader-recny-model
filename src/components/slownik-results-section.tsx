...
interface SlownikResultsSectionProps {
  resultFileUrl: string | null
  onReset: () => void
}

const SlownikResultsSection: FC<SlownikResultsSectionProps> = ({ resultFileUrl, onReset }) => {
  if (!resultFileUrl) {
    return null
  }
...
export default SlownikResultsSection
